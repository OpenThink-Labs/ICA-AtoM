...
<div class="actions section">
  ...
  <div class="content">
    <ul class="clearfix links">
      <li><?php // echo link_to(__('Browse all %1%', array('%1%' => render_title($resource->taxonomy))), array('module' => 'retention', 'action' => 'browse', 'id' => $resource->taxonomy->id)) // HACK Use id deliberately because "Subjects" and "Places" menus still use id ?></li>
    </ul>
  </div>
